...
> 在我的博客这里因为图太多+ GitHub 图床在大陆访问速度堪忧，预览效果非常烂……
>
> 所以**<u>有需要请直接去 [GitHub仓库页](https://github.com/Sayaka-4987/Sayaka-4987.github.io/tree/main/_posts) 里看 markdown 格式或PDF 发布版</u>**
>
...
| C++11 ![](media/855d298af58102dc05d82f82aebbf62f.webp) | C++14（新） ![](media/6a4881a0778d1cb3bb1982e7446f1fe3.webp) |
|-------------------------------------------------------|-------------------------------------------------------------|
...
| ![](media/2c493aa57aa9b9f86b8f150232765cbb.webp) | 编译时： ![](media/6481a40b44cad00ecd8690554c0ea7cd.webp) |
|-------------------------------------------------|----------------------------------------------------------|
...
![](media/ba2b56941bb86f51645b4c1c4bf14824.webp)
...
![](media/d786da0591008f12b385df37d0ab3daf.webp)
...
![](media/37398c1dff5ee459f42cd2f9d860a80e.webp)
...
![](media/0738fa8d6c580bca9d58c92f0cc9823a.webp)

### C++11：左值、右值、纯右值、将亡值

![](media/29ee7469eac41b724172b1e484b79d12.webp)

![](media/63d8dd18ff7944961572c3832b300e4c.webp)
...
![](media/9fd3a552a81b78813ddb2a1c73517039.webp)
...
![](media/8b87d40eb4c9f658da0b97f2c51958cd.webp)

#### std::weak_ptr，不会引起引用数增加的弱引用指针

![](media/d83551cd7ad6fd6988a6eb08d327628f.webp)
...
### C++11：constexpr类型![](media/b02dadd0bdb3a1bd6a9429644a7ca36f.webp)

constexpr指针只能指向nullptr、0、或储存在固定地址的对象

>   ![](media/df6f09692a0cd40946b944c876467ed8.webp)
...
![](media/36d77aa8e45de152aa49e64515a210b2.webp)

![](media/132a46c7781f3ecb2ea675d2a4a02dca.webp)
...
![](media/ca820f4b204457b98fe4db5f6fad1fa9.webp)

#### 待补充的引用折叠：auto &&i

![](media/e0c8276a9caf42877abdfc35e919c4f7.webp)

### C++11：decltype类型

![](media/34d9f23ccdfe72eea721dce8b8de02d5.webp)

和引用一起使用的时候，注意括号

![](media/187b878a23a612059314e19e8d2b264a.webp)

## 3.2、3.3 标准库类型string和vector

### C++：一些初始化写法

![](media/1295349bfde031c4537bb481a6c359fb.webp)

![](media/156ed811fa8647b384ff7952979eaad9.webp)

### C：cctype头文件中的函数

![](media/d35177ecc78cfa5e5088961c7e66f1e3.webp)

### C++11：size_type是无符号整型，避免和int混用

![](media/8223bbdab54129e8932430d4aef060e0.webp)

### 注意C++引用C的头文件格式

![](media/bfd173a27d6adc416b69ca1f0d45806d.webp)

### C++：初始化vector对象

![](media/004090856c1f6a93ddb9313f09937537.webp)![](media/019351c3bd67f47ca6b749a70c4f5ebe.webp)

![](media/64de940da46fa7fd5012e6431680e1cd.webp)

![](media/e002ce5f2d0e97226f23c047b4e291ad.webp)

### C++：vector适合动态添加元素

![](media/d512111d01e899ba593a27cdcda70884.webp)

### C++：养成使用迭代器和 != （而不是\<）判断循环的习惯

![](media/e2cf3e6a8116ca1afdef49e392bb0a9a.webp)

理由是：只有部分的标准库类型有下标运算符，大多数类型没有定义\<运算符

**但所有标准库容器都定义过==和!=，**养成这一编程习惯可以提高对类型的适应。

![](media/9c0758f5f30c9cbb03ec05ec09d7c378.webp)
...
![](media/e551c822c47870d0be35fc4ce7a8ea5b.webp)

### C++：强制类型转换

![](media/f3e2b0a1f495849adc257117cac16dd7.webp)

![](media/15489a53c807ae0f632087910727cd86.webp)这是用于代替C中强制类型转换的的(type)
expr的，还是要尽量避免强制类型转换。
...
![](media/b28359bc2bcb064e295091f3e78ea6fd.webp)

三部分：throw表达式，try语句块，catch子句

需要一套异常类用于传递异常的具体信息。

![](media/808f61a5c8890fc9223977da964847f9.webp)

### C++：标准库定义的标准异常

![](media/dd1bc5fecbc17e3adfe8b6ee1eb87dc7.webp)

![](media/801127cf50b62e2d1ef35f3797ed2d83.webp)

## 6.2.6 含有可变形参的函数

### C++11：initializer_list形参

![](media/abba4c1ccb0bcffb1981b0f4747a1112.webp)

![](media/ac6486609d0aeea3af892580c8511ee4.webp)

适合用于异常处理中，可以方便的逐个输出错误信息

![](media/5731ada95d14c7f8a58cd67988defaf9.webp)

### C++ ：省略符形参，访问一些特殊的C代码

特殊的C代码：指使用了varargs的C标准库功能

![](media/1c983c2757cc573e055d7c67890bfdc6.webp)
...
![](media/86aaec8f3168e13577ca790baf309b90.webp)

constexpr函数最大的特性：调用该函数的语句，会在编译阶段就被替换成这个函数返回结果的常量。

![](media/590f0db944a3ae925a4a12a3ae247dce.webp)
...
![](media/c2bb1d55a924828b8f788572a875e329.webp)
...
![](media/ef0d9784313f67de9d9568002671eff3.webp)

![](media/ef88084a8ee105b089a90efa17aca7f2.webp)

![](media/87e94dbdedde346c70592820bf3ce75b.webp)

### 关键字explicit：抑制构造函数定义的隐式转换

![](media/e463785d6df3b64e18af2efcbf97d096.webp)

### 聚合类：显式初始化类的对象![](media/4c11ce2074037fa5e14cf50058f3d699.webp)

### 字面值常量类：类的对象可以是字面常量

![](media/3a002354f142b835658d2e798e61672b.webp)

### C++11：constexpr构造函数

constexpr构造函数必须初始化所有数据成员、初始值、或者使用一个constexpr构造函数、或者是一条常量表达式。

![](media/51e944e349209110e32973ba3d2a4448.webp)

## 9 顺序容器

### STL顺序容器类型表和选择原则

![](media/51b20abce9aa04f74a335d8ed49ce262.webp)

占主导地位（访问/插入删除）的操作是什么，决定了容器类型的选择。

如果实在不确定用什么：只使用迭代器，不使用下标，避免随机访问，必要时在vector和list中选择。

![](media/d096bcd2c8db44be6f7ef88a9de8fde5.webp)

### 标准库容器操作

![](media/185f78149186c0db4c93787c686fe21b.webp)

![](media/022899f17ae057d55d4c539b2b000529.webp)

![](media/e67423e39dd362295f0fdbbb518607cf.webp)

### C++：标准库默认使用左闭合范围[begin, end)的好处

![](media/2a2f37798f98dd186176a783e7bdb0b4.webp)

反向迭代器和类型别名：

反向迭代器++指上一个元素。

![](media/50c1205b2d494d409851efb586145235.webp)

### C++：assign成员允许从相容的类型赋值

除array之外，顺序容器都有assign成员；

![](media/78bb4eee14b450ea21f0ee953249baaa.webp)
...
![](media/104453d1e234a1238c4d42b1035ddd58.webp)
...
![](media/897559bcfea4fea6a7604c0ce2c5306c.webp)

![](media/26394e6cc20cbd2bd41b4fc7a7fc15fe.webp)

一个实际操作例子：

![](media/5321062703afbf3612ea5955f961d9d6.webp)

### C++：string和数值转换函数

![](media/665613ba25268cd4fe6469c963714256.webp)
...
![](media/c80875a6284d12dedb1afd6f81a5fdd6.webp)
...
![](media/a04e57b282a35f38c72ab56160ecb2e0.webp)

![](media/b6f9fb45a5c02d8f516e4767876b662d.webp)

### C++标准库：写容器元素算法

![](media/3db219d75088c64a998d96cbaa9525b3.webp)
...
![](media/37e21ef2d428389e307d2c43b211c223.webp)

### C++：copy算法

![](media/e7f97ba932fa629a19934cda7123c68c.webp)

### C++：replace算法

![](media/f6d03131f273d42e3f9bd386b3c8ea6c.webp)

### C++标准库：重排容器元素的算法

操作实例：P396/864有一个删除重复单词的例子

![](media/29c66c419c8c6376990a651b73d5c174.webp)

## 10.3 定制操作

### C++：向算法传递谓词函数（以sort的比较函数为例）

![](media/e7bb7fc7995f0a887b9f30d67628bd2d.webp)
...
![](media/f60cddbdb0e6138b9dbfab60a4b11ac8.webp)

### C++11：lambda表达式

![](media/4adb6c763b036642abbb42e5ae0cdf82.webp)
...
-   lambda表达式是可调用对象，因此可代替一些简单函数，比如用作std::sort(std::begin(a),
    ...
    ![](media/b9034958cd86f54e9dae586361f7f749.webp)

-   lambda表达式的方括号内是捕获列表，不捕获就无法使用该变量，被捕获的变量只要不是const类型就可以被lambda表达式修改；

-   采用值俘获和引用俘获皆可，但应当尽可能的简单。

![](media/99ff2dec1cf892b07308cc1430e3c393.webp)

### C++11：lambda的隐式捕获

还可以让编译器根据lambda捕获列表里的**&**和**=**推断

![](media/ede0438b6d7ca5a38190f471048780c4.webp)

### C++11：lambda尾置返回类型

![](media/727a3c9d6f1d58966a3f2b55dc5a7ea4.webp)

### C++：for_each算法和lambda应用一例

![](media/090fbab7eb01453e9252fd01d857e319.webp)

### C++：placeholders名字

![](media/02224596bcc60cd88049e483aea05b95.webp)

更建议的写法：

![](media/4f4626fc1484cf581fce6d919377f2e5.webp)
...
![](media/54b0d827295a9327e728d8dab153a244.webp)

### 标准库bind函数应用举例

![](media/57aadd473788805abc0635055b959fd1.webp)

![](media/552676f24953b0be02120e9eb8e94884.webp)

![](media/43a2498591e30a15e1359f8210ee5600.webp)
...
![](media/8f6ea83271fc72d96300aa90d0e01aaf.webp)
...
![](media/0e3e61733c9415096ec4eea85dc70999.webp)

![](media/78ec42d9cfae62bf762b122c325811e2.webp)

### 应用举例：定义严格弱序的小于等于关键字

![](media/3cc62944415ed0377991bfdb683652f1.webp)

![](media/0e169fb8d3f1bd1aee14e26cb4bd717d.webp)
...
![](media/e65ab80a736b9b30597e1d401b312ad3.webp)

![](media/c90d7aa3c63b860205011e803b3d112c.webp)
...
![](media/d8fee477fdb87de58e9433397d2b551c.webp)

![](media/fe3ecd36a7e07ee05fba98c562a7c076.webp)

### set容器：用insert成员插入元素

![](media/617c2cc08bb5af771277444f7edd96dd.webp)

### insert操作表：

![](media/340eb13b0035f5956b45813732029038.webp)

### C++11：map容器要创建pair元素再插入

![](media/3f412b4fd8efe1cd82c51198ca34c214.webp)

![](media/e5ba76989ebf53e1b76412135622fc13.webp)

### 关联容器：用erase删除元素

![](media/71ae2cea556db51046b358b3d8dc0322.webp)

### 关联容器：查找元素的操作表

![](media/c2ecba760f960ffbe5403eceba86432b.webp)
...
![](media/b040cccfd4b44dc306e579201d61c121.webp)

### IO库条件状态表、状态恢复

用于访问和操作流的状态，控制修正错误；

![](media/adc1ebdacbba464724b5522b4e7de1cd.webp)

![](media/b0c42e7eadd1c05dc400f4624806b9ec.webp)

![](media/8b9789b82a17794c5e9c52b9af75b966.webp)

![](media/df95e681230a364c6c860f225d94ccef.webp)
...
![](media/2efbaabb55a3f7699d062047833ccdb2.webp)

### 流的关联

![](media/dc70e41159b21829a16fb67ff7fa7ae9.webp)

## 8.2 文件输入输出

文件名既可以是string，也可以是C风格字符串的指针；

![](media/dee0b90d7e938a42562267c609d0ce08.webp)

### fstream可以代替iostream&

![](media/cffe1681d0c54afab041ee0ad4eee803.webp)

##### 养成检查open的习惯

![](media/48234a6271768ef2a58db8607eac1a49.webp)

![](media/458a1b26814d59292120493901d2a3ec.webp)
...
![](media/4dca1dabcf017f90448e96d77293fd66.webp)

![](media/85d1c0018dbc88c61ab7ffa2227870df.webp)
...
![](media/c1f6a184ac2a247cf4945488089e3aaf.webp)

### C++11：shared_ptr

![](media/df496f9863fa393ccadd9fb08c59155e.webp)

![](media/c4bfd88977621332b65a36dcdae782e0.webp)

![](media/7f3f4c23ff5da09eaa7dcb5975abcb69.webp)
...
![](media/3e9026bae736aeb24f2ddf22d2db890d.webp)

### C++11：shared_ptr 的自动销毁

shared_ptr 指针析构时，同时会释放相关联的内存

![](media/c88d9d146819f9280a32e359997bb360.webp)
...
![](media/85b543618663d5c0bd169a95385d00f4.webp)

### C++：可传额外参数的定位new

![](media/9b72881e171d114833b1d04aee3e4bce.webp)

![](media/2f237a8b83eeb66177ee92d73407cecf.webp)
...
![](media/5e2d2844cf12ba779f40ad0718163f30.webp)

![](media/5c1764ae8cf9a2735e9d917b767a2aef.webp)

![](media/d5d858b0a5b93b99b71452a4b05c8262.webp)
...
![](media/b0ff69fb0f1dfded2d024f650646d3fa.webp)

### C++11：weak_ptr

![](media/c85915beb2369e994ddc94fa7a0e9ca5.webp)

## 13 拷贝控制

![](media/0193d0313e9346730d1f3fa86c3d6edd.webp)

#### 小结

![](media/a081838840f115c7fff1f288cdf9ec2e.webp)

### 拷贝构造函数

![](media/a7cbdaa3d70be57d7276736bcbf390e0.webp)
...
![](media/818b2a8963846a5edf1a83dee191453b.webp)

### 析构函数

![](media/16a35c5319291431f4d70cadb91f9845.webp)

![](media/e73185ccf64a40dff8c5db33992ed968.webp)

### =default显式要求编译器生成函数

![](media/f3f1a070f26c42c96b0fe58ad00a7f05.webp)

### =delete显示要求编译器删除成员

析构函数不能=delete，编译器将阻止不能被销毁的对象被创建

![](media/11104543974d69895dfc5a2cffdfbf32.webp)

![](media/75c1310de8f2d56c6616aee8c2252099.webp)

### 定义像值/像指针的类

![](media/9cd4bdbcc316738466983116b9af0d7a.webp)

![](media/76217fcd48e3ed7cb027e3fb8f99469a.webp)

### 引用计数详解

![](media/dbd7c033ee02c25d0c3bf0132af3b8d7.webp)

![](media/4c4254291f9f34308c8d6624dece7927.webp)

### 交换操作

![](media/e93d27c2bbb22290b91be2a31cd25a49.webp)

### P486/864有一个Message类的应用实例

### C++11：右值移动

![](media/f4cfd6ac75b66db4b73a5f5713fdbca2.webp)

#### 右值引用指向将要被销毁的对象

![](media/d68b79c2acb50a94d18eda5ab9d40d5e.webp)

#### 变量表达式都是左值，右值引用不能绑定到右值引用类型变量上

![](media/d12f6433e398bc1cd603e3ff47ed1863.webp)

### C++11：标准库move函数

可以获得绑定到左值上的右值引用

![](media/a3d76da66ef310499bfef39e046ff7af.webp)

![](media/feeadf39c7b7c1fdcac806c7b0d03e9d.webp)

### 移动构造函数

移动构造函数的第一个参数是该类类型的一个右值引用

![](media/5ed83f1018a318b6cd00900819995d46.webp)
...
![](media/a028d03dcde49e2d11af8792a3f028a3.webp)

![](media/ac5a89d7a65ab47fe040b65c7aa7a3cb.webp)

![](media/b964ea07442e61127e7d8a55fb0c7d4b.webp)

### C++11：移动迭代器

![](media/6a3dc75235a377100dcd8c0da7194dee.webp)
...
![](media/9ed2222920679effc0cd7669d2b1d96b.webp)

![](media/3f75f0c30a88fca1bb1ef25c88fbc425.webp)

#### 引用限定符也可以区分重载版本

![](media/24ce0c89c91aea219281343c1ccf65ae.webp)![](media/fc602a40e994a7c23bd2e278658f381a.webp)

## 16.2 模板实参推断

### C++11：将模板类型参数声明为友元

![](media/01e33da3d2167e81e8881b528a6f40bf.webp)

### C++11：为类模板定义类型别名

![](media/eb31202eb03e6f241a82ecbdc0b7a693.webp)

### C++：显式提示编译器一个名字表示类型

![](media/74b96dce8ec117e3d20a1a436b8674cc.webp)

### C++11：尾置返回类型

![](media/7e8c7f92e114ca819f190a5cd038704c.webp)

### C++11：标准类型转换模板

![](media/76547de2e874c75894fcd16dc978e110.webp)

### C++：函数指针和模板实参

![](media/75e5bae6ad40eb6bceb3d8aef5ed482d.webp)

#### 显式模板实参：

![](media/b77cebb4bed2fa8bb6f2ff3fc87f4cff.webp)

### C++：模板实参推断和引用

![](media/69fbbd868d3c8faa87ead8b11a27f297.webp)

![](media/d41d9421e7327946e404424abda98d7f.webp)

![](media/a2728ceba53657c08925c95924334db5.webp)

### C++11：引用折叠

![](media/87deae1568c2c044ec936bba51a92ada.webp)

![](media/c9682d2a18d72d5bf062b3c7114d9897.webp)

#### 万能引用：可以给T &&类型的参数传递左值或右值

![](media/bc93e9d60b2023957fd967c2b3381373.webp)

#### 标准库定义的std::move

##### std::move如何定义

![](media/07a97aa303f00f9321e7eb9108fa7c49.webp)

##### std::move如何工作

![](media/ea951b70153438e8426c778dd51657a7.webp)

### C++11：允许用static_cast显式把左值转换为右值引用

![](media/23f32869eb6f4708423baa54789009ea.webp)

### 将一个函数的实参转发给其他函数

![](media/267041c0f29594bf9ae0907cd611ad5c.webp)

#### 用引用折叠保持左值、右值属性

![](media/10801774c1c64d3f6a2a1ec4a0ef3531.webp)

### C++11：用std::forward保持类型信息

![](media/51324c197e0304712076ecec308be90d.webp)
...
-   tuple类型必须直接初始化；
    ...
    ![](media/b917825a4de5468fde1f6de8dfe5ba98.webp)
...
![](media/a12f10c8542e835aac2e652a26d312db.webp)

#### tuple操作表

![](media/f47e8aacc8cee7b294e0380aef32c4a9.webp)

![](media/78f655be561e6f7a6b02d319235c27c5.webp)
...
![](media/ccddfdc5f144e30a7fb318db5632a570.webp)
...
![](media/d84cb1898e33e82431a301c12df984e9.webp)

### 几个使用范例：正则表达式库

![](media/3a01006a68d9bbde51cef6e546c73b10.webp)

![](media/595dd205461146062f573ff7816dac1d.webp)

![](media/1dd967a62d497f3cd57910c9e796b5e2.webp)
...
![](media/9e0b41507e0d08528be98138d7e478a4.webp)

![](media/373e288773c79f600bf954f79ab3ace6.webp)

#### `regex`选项表

![](media/a5587e6ad7c2180531d10340a66df95b.webp)

### 正则表达式语言中的转义字符

![](media/aea063fb7e3fc8a306068cc6b889c7b2.webp)

### RE库的异常处理

#### 注意：正则表达式在运行时才编译

![](media/00bc0aa90b952483600c12e6139be9ba.webp)

![](media/da5870c48a966642738735dccdde31b5.webp)

### 正则表达式错误类型表

![](media/0f399babc5b6e3e42f2c8f48c6866789.webp)

### RE库类型必须与输入序列类型匹配

![](media/02394aaeff110b3e5a9235a6cf2a1e2d.webp)

![](media/67d63b4a469470a727af911c5700450e.webp)

### Regex迭代器sregex_iterator

![](media/7e1f65ff9a47a3eac9fb299ee10ae4b7.webp)

![](media/81623a6946bfd054fe130a60ec4480a2.webp)

### sregex_iterator使用示例

![](media/face20b74e76491e8885c2dfa5a85ad9.webp)

#### match操作表

![](media/3bfa5b163ad7c342975173b4fc209e9a.webp)

#### 子匹配操作表

![](media/efa358793ab4be7606dfd1bb7ca2718a.webp)

### regex_replace查找替换一个正则表达式![](media/4b57cb2dd3106f3c7480bf16c534b491.webp)

#### 匹配标志表

![](media/bc9677c10b759dc0ec76415777d93f89.webp)

## 18.1 异常处理

异常处理机制的主要作用是，将问题的检测和解决过程分离，检测过程无需知道问题处理模块的细节；

![](media/329a24170b21975b6446fa785f95ed7e.webp)

### 抛出异常后的栈展开流程

![](media/e9b63f66ce1869642cfd809dabb47956.webp)

若调用链上的语句块出现异常，而提前终止，则这一部分语句块的局部对象将被销毁（通过执行析构函数）；但其他释放资源的代码可能被跳过；

![](media/9e370867b7f770adc4fc18730d68f92e.webp)

![](media/0312feba170ceaa1222d90f0c5028679.webp)

![](media/d825580bce0200cead700418a2819ba5.webp)

### 捕获异常的流程

#### 异常声明

![](media/2822cc3ba50ac1719280d761b804c4b3.webp)
...
![](media/50e5aba63ff3ed2bb8123b4d06beefab.webp)
...
![](media/523d50fd7782c755759abb961961db8f.webp)

### C++11：noexcept说明和noexcept运算符

![](media/350dc1bec9322b158a3695db911fddc5.webp)

![](media/fb19b17250cee127881c59c4fb892301.webp)
...
>   ![](media/35525646405fab8e9a5b38d8e0a0adf1.webp)

#### 使用自己定义的异常类![](media/683acfdb5fc2e6b9b8a4d023596137ff.webp)
...
![](media/5427781b50202acd7b39a42c620f9fb1.webp)

### 嵌套命名空间

![](media/90aa72cc80f6b6d92f7b10d03097413f.webp)

### C++11：内联命名空间

关键词inline必须出现在命名空间第一次定义的地方，此后可写可不写；

![](media/057e6ab3263b5ac1bf838305f31a6de2.webp)

#### 未命名的命名空间

![](media/1eacb5b5bc05e5d67b2ea8a94fc3ce89.webp)

#### 命名空间的别名

![](media/12d15241ff06d67fdb9c15b6f218e447.webp)
...
![](media/92570ca576999e1d4889c358c17489cb.webp)

#### 避免使用 using namespace std

![](media/0fa864b5ecf15685acddde264b6313fc.webp)

#### std::move和std::forward函数必须带限定语

![](media/bde2eec1ab91988d31a969b398207c4a.webp)
...
![](media/7842b65cfb9d0b57ba1140e1258d1488.webp)
...
![](media/60273b1a008641058cc555e6df5e2288.webp)

### C++11：指定enum大小

![](media/ae1f410ddb2f2649c828455f3ae87b19.webp)

### C++11：提前声明enum

![](media/e289f3c56b787cefaaced643c4a14d24.webp)
...
![](media/81da8d6ca408967a07e90e1ed269c8a9.webp)
...
![](media/f857bc330caa80ffcfb8ef1d7e6ad492.webp)

##### [加号](https://github.com/cdoco/learn-`regex`-zh#232-%E5%8A%A0%E5%8F%B7)：表示匹配上一个字符一次或多次

![](media/7010e441baf178f4802114bc6b5c93ed.webp)

##### 问号：表示匹配上一个字符一次或零次

![](media/123b44fa1b45606deea1f1ae6fbe4c29.webp)

##### 花括号：指定可以重复的次数

![](media/946206383d735d05703f2c7945eeee85.webp)

##### 字符组：一组写在圆括号内用垂直条分隔的子模式

![](media/5e4b4b410a23e7eef5267a02fa51c345.webp)

#### 分支结构

##### 垂直条：用来定义分支结构

![](media/e225b3838e5e39fe40cdaf078dc06f3e.webp)

#### 反斜杠：转义特殊字符

注意：在**写代码时需要两个斜杠 \\\\\^** ，第一个斜杠转义下一个斜杠；

![](media/caa6e37dac0dea7e1390e643de22aa07.webp)

#### 定位符

##### 插入符号：检查匹配字符是否是输入字符串的第一个字符

![](media/1b2c2e5c0bcbeb786dcda24f9c0bd6a5.webp)

##### 美元符号：检查匹配字符是否是输入字符串的最后一个字符

![](media/841c937d124d7108a03ba28ee13ca18b.webp)
...
![](media/4b8a72320e952e72f680a2973d632e33.webp)

#### 正向先行断言

![](media/dd3f0b2eb244098b15a4e6c8c99cdaa4.webp)

#### 负向先行断言

![](media/e477e930651d6b9a167ce8707c44402c.webp)

#### 正向后行断言

![](media/5f6efb2d18abe7fdb8975ed361c99e2a.webp)

#### 负向后行断言

![](media/ccfc543552630f27c263518e54d81847.webp)
...
![](media/bea7ffd1b93d4bb52861dd65a6314fa5.webp)

#### g修饰符：全局搜索

![](media/65a0d27bb3f86fbd2e2c310659cc3967.webp)

#### m修饰符：多行匹配

![](media/2dceab2456d99be8bf2018a74d45b2a7.webp)
...
VS中的设置方法如下图![](media/78bf98a6f5c3cd0e9bf9b87a885f1551.webp)

### 将C++标准库用作模块

告别头文件只需要这么一行：

![](media/edf6810fb8d2b0918697cbfe7c0cc2f0.webp)
