...
这篇不是“擅自建立、使用非法定信道进行国际联网”的教程，配个 REALITY 协议的 VPN 很容易，不需要我教。

这是一次我以为可以无脑的让 Agent 给我 --yolo 配一个简单的工具，结果最后变成在补课计算机基础知识、debug Linux、systemd 和网络的故事。

一开始我全程在 vibe coding，打开 GPT，让 G 老师丢给我一份傻瓜复制脚本，改几行参数，一路梭哈下去。结果你大概也猜得到，表面上是跑起来了，实际完全没通。
